...
// Forwards a ref to the underlying <input> so callers (e.g. the search-miss
// Clear-search button) can return focus to it after resetting the filter.
export const DestinationSearch = forwardRef<HTMLInputElement>(
  function DestinationSearch(_props, ref) {
    ...
    // Keep the local input value in sync when the store query is reset
    // externally (e.g. the Clear-search button in the search-miss state).
    useEffect(() => {
