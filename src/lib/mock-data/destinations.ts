...
export const mockDestinations: MockDestination[] = [
  ...
  dest(22, 'Albania', 'albania', 'AL', 'europe', 'https://images.unsplash.com/photo-1602847783933-bcc2f2bc0e0c?w=600&h=450&fit=crop', 13),
  dest(23, 'Andorra', 'andorra', 'AD', 'europe', 'https://images.unsplash.com/photo-1605362030495-4f4b4dd5a98c?w=600&h=450&fit=crop', 14),
  ...
  dest(27, 'Bulgaria', 'bulgaria', 'BG', 'europe', 'https://images.unsplash.com/photo-1554539924-ab17ad5e84aa?w=600&h=450&fit=crop', 18),
  dest(28, 'Croatia', 'croatia', 'HR', 'europe', 'https://images.unsplash.com/photo-1555990793-dc9c5f7b7c1f?w=600&h=450&fit=crop', 19),
  dest(29, 'Cyprus', 'cyprus', 'CY', 'europe', 'https://images.unsplash.com/photo-1561641998-9dd2eb8a8b3c?w=600&h=450&fit=crop', 20),
  dest(100, 'Denmark', 'denmark', 'DK', 'europe', 'https://images.unsplash.com/photo-1513622470522-26c3c8a854bc?w=600&h=450&fit=crop', 21),
  dest(101, 'Estonia', 'estonia', 'EE', 'europe', 'https://images.unsplash.com/photo-1547922430-b13e7eb4b4f0?w=600&h=450&fit=crop', 22),
  dest(102, 'Finland', 'finland', 'FI', 'europe', 'https://images.unsplash.com/photo-1568814520637-7ddb8c87c6c0?w=600&h=450&fit=crop', 23),
  dest(103, 'Georgia', 'georgia', 'GE', 'europe', 'https://images.unsplash.com/photo-1593003419566-3aa6f7d3b87e?w=600&h=450&fit=crop', 24),
  dest(104, 'Hungary', 'hungary', 'HU', 'europe', 'https://images.unsplash.com/photo-1551867633-194f125bddfa?w=600&h=450&fit=crop', 25),
  dest(105, 'Iceland', 'iceland', 'IS', 'europe', 'https://images.unsplash.com/photo-1490650404144-1e94a3a6c4ac?w=600&h=450&fit=crop', 26),
  dest(106, 'Ireland', 'ireland', 'IE', 'europe', 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=600&h=450&fit=crop', 27),
  dest(107, 'Latvia', 'latvia', 'LV', 'europe', 'https://images.unsplash.com/photo-1520637836862-4d197d17c33a?w=600&h=450&fit=crop', 28),
  dest(108, 'Liechtenstein', 'liechtenstein', 'LI', 'europe', 'https://images.unsplash.com/photo-1581929768-6bc2c2ace3c1?w=600&h=450&fit=crop', 29),
  ...
  dest(110, 'Luxembourg', 'luxembourg', 'LU', 'europe', 'https://images.unsplash.com/photo-1588666309990-7a7e1a8d6f3d?w=600&h=450&fit=crop', 31),
  dest(111, 'Malta', 'malta', 'MT', 'europe', 'https://images.unsplash.com/photo-1589306345048-29302ca12e2c?w=600&h=450&fit=crop', 32),
  dest(112, 'Moldova', 'moldova', 'MD', 'europe', 'https://images.unsplash.com/photo-1582789664-5be8eedb1f47?w=600&h=450&fit=crop', 33),
  dest(113, 'Montenegro', 'montenegro', 'ME', 'europe', 'https://images.unsplash.com/photo-1576081540975-6e9b5e5b1c3a?w=600&h=450&fit=crop', 34),
  dest(114, 'North Macedonia', 'north-macedonia', 'MK', 'europe', 'https://images.unsplash.com/photo-1571645163064-fb3a3f99cf6b?w=600&h=450&fit=crop', 35),
  dest(115, 'Norway', 'norway', 'NO', 'europe', 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?w=600&h=450&fit=crop', 36),
  dest(116, 'Romania', 'romania', 'RO', 'europe', 'https://images.unsplash.com/photo-1593007301-a5d4f3f3a3f7?w=600&h=450&fit=crop', 37),
  dest(117, 'San Marino', 'san-marino', 'SM', 'europe', 'https://images.unsplash.com/photo-1601033893080-b9c75ef58c91?w=600&h=450&fit=crop', 38),
  dest(118, 'Serbia', 'serbia', 'RS', 'europe', 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=600&h=450&fit=crop', 39),
  dest(119, 'Slovakia', 'slovakia', 'SK', 'europe', 'https://images.unsplash.com/photo-1568863-bcb46a87b8b8?w=600&h=450&fit=crop', 40),
  dest(120, 'Slovenia', 'slovenia', 'SI', 'europe', 'https://images.unsplash.com/photo-1532289873-2cd1cd2da4c1?w=600&h=450&fit=crop', 41),
